...
better performance. Still, none of my future code reviews shall impair or change the
way EZ components works. Reviews will be made to improve performance and assure good
behavior on both platforms.

EZAppMaker comprises a set of components that will show the same appearance and behavior on both,
